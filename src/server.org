...
#+begin_src nim :noweb-ref device-to-json
  let body = %*{"mac": mac, "address": address, "system-board": system, "lock-board": lock, "wireless": wireless, "antenna": antenna, "card-reader": card_reader, "lock-amount": lock_amount, "router-board": router, "sim-no": sim_no}
#+end_src
